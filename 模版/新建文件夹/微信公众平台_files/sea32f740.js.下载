...
var n="mp.weixin.qq.com"==location.hostname||"mpc.weixin.qq.com"==location.hostname||"mpd.weixin.qq.com"==location.hostname?"https://res.wx.qq.com/":"/",t=function(e){
var n=e.lastIndexOf(".");
return n>=0?e.substring(n):"";
};
"undefined"!=typeof MODULES&&(n+="c/=");
var i=e.data.pathinfo={
".js":"wxopenres/zh_CN/htmledition/js/",
".tpl":"wxopenres/zh_CN/htmledition/js/",
".html":"wxopenres/zh_CN/htmledition/js/",
".css":"wxopenres/htmledition/style/"
};
e.config({
base:n,
map:[function(n){
var s=t(n),o=e.data.base,a=n.substr(o.length);
if("undefined"!=typeof MODULES&&MODULES[a]){
var c=MODULES[a],r=c;
return 0==r.indexOf("http://")||0==r.indexOf("https://")?r:(-1==r.indexOf(o.replace("/c/=",""))&&(r=o+c),
".js"!=s&&".css"!=s&&(r=r.replace("/c/=","")),r);
}
return o.replace("/c/=","")+i[s]+a+"?20130807";
}]
});
}(seajs);;